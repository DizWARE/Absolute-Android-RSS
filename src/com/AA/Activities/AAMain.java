...
public class AAMain extends ListActivity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		this.registerReceiver(finishReceiver, new IntentFilter("RSS Finish"));  
    ...
    {
    	AlarmReceiver.startAlarm(this, settings.getLong("freq", 2));
    	super.onDestroy();
    }
    ...
    private void refresh()
    {
    	...
    	articles.add(new Article("This is article #" + articles.size(),
    			"Article " + articles.size(), "Uhhh", "http://www.google.com"));
    	adapter.clear();
    ...
    private void shareDialog(Article a)
    {
    	...
    	shareChooser.putExtra(Intent.EXTRA_SUBJECT, "Check this article out");
    	shareChooser.putExtra(Intent.EXTRA_TEXT, a.getTitle() + " from Absolutely Android\n" +
    									 a.getDescription() + "\n" +
    									 "To read more, click this link(or copy it into URL bar): " + a.getUrl());
    	
    	startActivity(Intent.createChooser(shareChooser, "How do you want to share?"));
    }
    ...
    private class ArticleAdapter extends ArrayAdapter<Article>
    {
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			LayoutInflater inflater = AAMain.this.getLayoutInflater();
    		...
    		TextView tv_description = (TextView)row.findViewById(R.id.tv_description);
    		...
    		if(article.isRead())
    			bgColor = settings.getInt("colorRead", Color.CYAN);
    		else
    			bgColor = settings.getInt("colorUnread", Color.MAGENTA);   		
